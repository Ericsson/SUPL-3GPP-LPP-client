...
- Added new format option `lrf-uper` to output RTCM framed UPER encoded 3GPP LPP messages. Right now, we use an experimental message id of 83 for the RTCM messages.
