...
asn_TYPE_member_t asn_MBR_BT_ProvideCapabilities_r13_1[] = {
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_bt_MeasSupported_r13_constr_5,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
	...
	{ ATF_POINTER, 2, offsetof(struct BT_ProvideCapabilities_r13, ext1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext1_8,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct BT_ProvideCapabilities_r13, ext2),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext2_12,
		0,
...
static const int asn_MAP_BT_ProvideCapabilities_r13_oms_1[] = { 2, 3 };
