...
static asn_per_constraints_t asn_PER_memb_cellIdentity_constr_8 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  16,  16 }	/* (SIZE(16..16)) */,
	0, 0	/* No PER value map */
};
...
static asn_SET_OF_specifics_t asn_SPC_mcc_specs_3 = {
	sizeof(struct CellGlobalIdGERAN__plmn_Identity__mcc),
	offsetof(struct CellGlobalIdGERAN__plmn_Identity__mcc, _asn_ctx),
...
static asn_SET_OF_specifics_t asn_SPC_mnc_specs_5 = {
	sizeof(struct CellGlobalIdGERAN__plmn_Identity__mnc),
	offsetof(struct CellGlobalIdGERAN__plmn_Identity__mnc, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
...
static asn_TYPE_member_t asn_MBR_plmn_Identity_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CellGlobalIdGERAN__plmn_Identity, mcc),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_mcc_3,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CellGlobalIdGERAN__plmn_Identity, mnc),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_mnc_5,
		0,
...
static asn_SEQUENCE_specifics_t asn_SPC_plmn_Identity_specs_2 = {
	sizeof(struct CellGlobalIdGERAN__plmn_Identity),
	offsetof(struct CellGlobalIdGERAN__plmn_Identity, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_CellGlobalIdGERAN_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CellGlobalIdGERAN, locationAreaCode),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_locationAreaCode_constr_7,  memb_locationAreaCode_constraint_1 },
		0, 0, /* No default value */
		"locationAreaCode"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CellGlobalIdGERAN, cellIdentity),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_cellIdentity_constr_8,  memb_cellIdentity_constraint_1 },
		0, 0, /* No default value */
		"cellIdentity"
		},
};
