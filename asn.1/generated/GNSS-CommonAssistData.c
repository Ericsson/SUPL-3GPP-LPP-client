...
asn_TYPE_member_t asn_MBR_GNSS_CommonAssistData_1[] = {
	{ ATF_POINTER, 7, offsetof(struct GNSS_CommonAssistData, gnss_ReferenceTime),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 6, offsetof(struct GNSS_CommonAssistData, gnss_ReferenceLocation),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 5, offsetof(struct GNSS_CommonAssistData, gnss_IonosphericModel),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct GNSS_CommonAssistData, gnss_EarthOrientationParameters),
	...
	{ ATF_POINTER, 3, offsetof(struct GNSS_CommonAssistData, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_7,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct GNSS_CommonAssistData, ext2),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext2_11,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct GNSS_CommonAssistData, ext3),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext3_13,
		0,
...
static const int asn_MAP_GNSS_CommonAssistData_oms_1[] = { 0, 1, 2, 3, 4, 5, 6 };
