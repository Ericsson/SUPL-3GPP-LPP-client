...
asn_TYPE_member_t asn_MBR_GNSS_DifferentialCorrectionsSupport_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct GNSS_DifferentialCorrectionsSupport, gnssSignalIDs),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct GNSS_DifferentialCorrectionsSupport, dgnss_ValidityTimeSup),
...
static const ber_tlv_tag_t asn_DEF_GNSS_DifferentialCorrectionsSupport_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_GNSS_DifferentialCorrectionsSupport_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* gnssSignalIDs */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* dgnss-ValidityTimeSup */
};
