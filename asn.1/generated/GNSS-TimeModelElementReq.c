...
static int
memb_gnss_TO_IDsReq_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
asn_TYPE_member_t asn_MBR_GNSS_TimeModelElementReq_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct GNSS_TimeModelElementReq, gnss_TO_IDsReq),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_gnss_TO_IDsReq_constr_2,  memb_gnss_TO_IDsReq_constraint_1 },
		0, 0, /* No default value */
		"gnss-TO-IDsReq"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct GNSS_TimeModelElementReq, deltaTreq),
