...
static int
memb_uncertspeed_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	const BIT_STRING_t *st = (const BIT_STRING_t *)sptr;
	size_t size;
...
static asn_per_constraints_t asn_PER_memb_horspeed_constr_3 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  16,  16 }	/* (SIZE(16..16)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_uncertspeed_constr_4 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  8,  8 }	/* (SIZE(8..8)) */,
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_Horveluncert_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Horveluncert, horspeed),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_horspeed_constr_3,  memb_horspeed_constraint_1 },
		0, 0, /* No default value */
		"horspeed"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct Horveluncert, uncertspeed),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_uncertspeed_constr_4,  memb_uncertspeed_constraint_1 },
		0, 0, /* No default value */
		"uncertspeed"
		},
};
