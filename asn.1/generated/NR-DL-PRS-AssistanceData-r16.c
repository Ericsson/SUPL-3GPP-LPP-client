...
asn_TYPE_descriptor_t asn_DEF_nr_DL_PRS_AssistanceDataList_r16_3 = {
	...
	{ 0, &asn_PER_type_nr_DL_PRS_AssistanceDataList_r16_constr_3, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_nr_SSB_Config_r16_5 = {
	...
	{ 0, &asn_PER_type_nr_SSB_Config_r16_constr_5, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_NR_DL_PRS_AssistanceData_r16_1[] = {
	{ ATF_POINTER, 1, offsetof(struct NR_DL_PRS_AssistanceData_r16, nr_DL_PRS_ReferenceInfo_r16),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NR_DL_PRS_AssistanceData_r16, nr_DL_PRS_AssistanceDataList_r16),
		...
		0,
		{ 0, &asn_PER_memb_nr_DL_PRS_AssistanceDataList_r16_constr_3,  memb_nr_DL_PRS_AssistanceDataList_r16_constraint_1 },
		0, 0, /* No default value */
		"nr-DL-PRS-AssistanceDataList-r16"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct NR_DL_PRS_AssistanceData_r16, nr_SSB_Config_r16),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_nr_SSB_Config_r16_5,
		0,
		{ 0, &asn_PER_memb_nr_SSB_Config_r16_constr_5,  memb_nr_SSB_Config_r16_constraint_1 },
		0, 0, /* No default value */
		"nr-SSB-Config-r16"
		},
};
static const int asn_MAP_NR_DL_PRS_AssistanceData_r16_oms_1[] = { 0 };
