...
asn_TYPE_member_t asn_MBR_NR_DL_TDOA_LocationInformation_r16_1[] = {
	{ ATF_POINTER, 1, offsetof(struct NR_DL_TDOA_LocationInformation_r16, measurementReferenceTime_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static const int asn_MAP_NR_DL_TDOA_LocationInformation_r16_oms_1[] = { 0 };
