...
asn_TYPE_member_t asn_MBR_NR_DL_TDOA_ProvideLocationInformation_r16_1[] = {
	{ ATF_POINTER, 3, offsetof(struct NR_DL_TDOA_ProvideLocationInformation_r16, nr_DL_TDOA_SignalMeasurementInformation_r16),
	...
	{ ATF_POINTER, 2, offsetof(struct NR_DL_TDOA_ProvideLocationInformation_r16, nr_dl_tdoa_LocationInformation_r16),
	...
	{ ATF_POINTER, 1, offsetof(struct NR_DL_TDOA_ProvideLocationInformation_r16, nr_DL_TDOA_Error_r16),
...
static const int asn_MAP_NR_DL_TDOA_ProvideLocationInformation_r16_oms_1[] = { 0, 1, 2 };
