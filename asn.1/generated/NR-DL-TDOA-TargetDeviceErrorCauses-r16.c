...
asn_TYPE_member_t asn_MBR_NR_DL_TDOA_TargetDeviceErrorCauses_r16_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct NR_DL_TDOA_TargetDeviceErrorCauses_r16, nr_PRS_RSRPMeasurementNotPossible_r16),
	...
	{ ATF_POINTER, 1, offsetof(struct NR_DL_TDOA_TargetDeviceErrorCauses_r16, nr_RSTDMeasurementNotPossible_r16),
		...
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"nr-RSTDMeasurementNotPossible-r16"
		},
};
static const int asn_MAP_NR_DL_TDOA_TargetDeviceErrorCauses_r16_oms_1[] = { 1, 2 };
...
static const asn_TYPE_tag2member_t asn_MAP_NR_DL_TDOA_TargetDeviceErrorCauses_r16_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* nr-RSTDMeasurementNotPossible-r16 */
};
