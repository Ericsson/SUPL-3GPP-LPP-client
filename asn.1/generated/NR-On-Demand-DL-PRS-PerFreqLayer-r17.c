...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_dl_prs_ResourceRepetitionFactorReq_r17_constr_29 CC_NOTUSED = {
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_dl_prs_NumSymbolsReq_r17_constr_37 CC_NOTUSED = {
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_dl_prs_CombSizeN_Req_r17_constr_43 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  2,  2,  0,  3 }	/* (0..3,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_dl_prs_ResourceBandwidthReq_r17_constr_28 CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t asn_MAP_dl_prs_ResourceRepetitionFactorReq_r17_value2enum_29[] = {
	{ 0,	2,	"n2" },
	{ 1,	2,	"n4" },
	{ 2,	2,	"n6" },
	{ 3,	2,	"n8" },
...
static const unsigned int asn_MAP_dl_prs_ResourceRepetitionFactorReq_r17_enum2value_29[] = {
	4,	/* n16(4) */
	0,	/* n2(0) */
	5,	/* n32(5) */
	1,	/* n4(1) */
...
static const asn_INTEGER_specifics_t asn_SPC_dl_prs_ResourceRepetitionFactorReq_r17_specs_29 = {
	asn_MAP_dl_prs_ResourceRepetitionFactorReq_r17_value2enum_29,	/* "tag" => N; sorted by tag */
	asn_MAP_dl_prs_ResourceRepetitionFactorReq_r17_enum2value_29,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_dl_prs_ResourceRepetitionFactorReq_r17_tags_29[] = {
	(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_dl_prs_ResourceRepetitionFactorReq_r17_29 = {
	"dl-prs-ResourceRepetitionFactorReq-r17",
	"dl-prs-ResourceRepetitionFactorReq-r17",
	&asn_OP_NativeEnumerated,
	asn_DEF_dl_prs_ResourceRepetitionFactorReq_r17_tags_29,
	sizeof(asn_DEF_dl_prs_ResourceRepetitionFactorReq_r17_tags_29)
		/sizeof(asn_DEF_dl_prs_ResourceRepetitionFactorReq_r17_tags_29[0]) - 1, /* 1 */
	asn_DEF_dl_prs_ResourceRepetitionFactorReq_r17_tags_29,	/* Same as above */
	sizeof(asn_DEF_dl_prs_ResourceRepetitionFactorReq_r17_tags_29)
		/sizeof(asn_DEF_dl_prs_ResourceRepetitionFactorReq_r17_tags_29[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_dl_prs_ResourceRepetitionFactorReq_r17_constr_29,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		NativeEnumerated_constraint
	},
	0, 0,	/* Defined elsewhere */
	&asn_SPC_dl_prs_ResourceRepetitionFactorReq_r17_specs_29	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_dl_prs_NumSymbolsReq_r17_value2enum_37[] = {
	{ 0,	2,	"n2" },
	{ 1,	2,	"n4" },
	{ 2,	2,	"n6" },
	{ 3,	3,	"n12" }
...
static const unsigned int asn_MAP_dl_prs_NumSymbolsReq_r17_enum2value_37[] = {
	3,	/* n12(3) */
	0,	/* n2(0) */
	1,	/* n4(1) */
	2	/* n6(2) */
...
static const asn_INTEGER_specifics_t asn_SPC_dl_prs_NumSymbolsReq_r17_specs_37 = {
	asn_MAP_dl_prs_NumSymbolsReq_r17_value2enum_37,	/* "tag" => N; sorted by tag */
	asn_MAP_dl_prs_NumSymbolsReq_r17_enum2value_37,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_dl_prs_NumSymbolsReq_r17_tags_37[] = {
	(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_dl_prs_NumSymbolsReq_r17_37 = {
	"dl-prs-NumSymbolsReq-r17",
	"dl-prs-NumSymbolsReq-r17",
	&asn_OP_NativeEnumerated,
	asn_DEF_dl_prs_NumSymbolsReq_r17_tags_37,
	sizeof(asn_DEF_dl_prs_NumSymbolsReq_r17_tags_37)
		/sizeof(asn_DEF_dl_prs_NumSymbolsReq_r17_tags_37[0]) - 1, /* 1 */
	asn_DEF_dl_prs_NumSymbolsReq_r17_tags_37,	/* Same as above */
	sizeof(asn_DEF_dl_prs_NumSymbolsReq_r17_tags_37)
		/sizeof(asn_DEF_dl_prs_NumSymbolsReq_r17_tags_37[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_dl_prs_NumSymbolsReq_r17_constr_37,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		NativeEnumerated_constraint
	},
	0, 0,	/* Defined elsewhere */
	&asn_SPC_dl_prs_NumSymbolsReq_r17_specs_37	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_dl_prs_CombSizeN_Req_r17_value2enum_43[] = {
	{ 0,	2,	"n2" },
	{ 1,	2,	"n4" },
	{ 2,	2,	"n6" },
	{ 3,	3,	"n12" }
...
static const unsigned int asn_MAP_dl_prs_CombSizeN_Req_r17_enum2value_43[] = {
	3,	/* n12(3) */
	0,	/* n2(0) */
	1,	/* n4(1) */
	2	/* n6(2) */
...
static const asn_INTEGER_specifics_t asn_SPC_dl_prs_CombSizeN_Req_r17_specs_43 = {
	asn_MAP_dl_prs_CombSizeN_Req_r17_value2enum_43,	/* "tag" => N; sorted by tag */
	asn_MAP_dl_prs_CombSizeN_Req_r17_enum2value_43,	/* N => "tag"; sorted by N */
	4,	/* Number of elements in the maps */
	5,	/* Extensions before this member */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_dl_prs_CombSizeN_Req_r17_tags_43[] = {
	(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_dl_prs_CombSizeN_Req_r17_43 = {
	"dl-prs-CombSizeN-Req-r17",
	"dl-prs-CombSizeN-Req-r17",
	&asn_OP_NativeEnumerated,
	asn_DEF_dl_prs_CombSizeN_Req_r17_tags_43,
	sizeof(asn_DEF_dl_prs_CombSizeN_Req_r17_tags_43)
		/sizeof(asn_DEF_dl_prs_CombSizeN_Req_r17_tags_43[0]) - 1, /* 1 */
	asn_DEF_dl_prs_CombSizeN_Req_r17_tags_43,	/* Same as above */
	sizeof(asn_DEF_dl_prs_CombSizeN_Req_r17_tags_43)
		/sizeof(asn_DEF_dl_prs_CombSizeN_Req_r17_tags_43[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_dl_prs_CombSizeN_Req_r17_constr_43,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		NativeEnumerated_constraint
	},
	0, 0,	/* Defined elsewhere */
	&asn_SPC_dl_prs_CombSizeN_Req_r17_specs_43	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_NR_On_Demand_DL_PRS_PerFreqLayer_r17_1[] = {
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_dl_prs_ResourceBandwidthReq_r17_constr_28,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
	...
	{ ATF_POINTER, 4, offsetof(struct NR_On_Demand_DL_PRS_PerFreqLayer_r17, dl_prs_ResourceRepetitionFactorReq_r17),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_dl_prs_ResourceRepetitionFactorReq_r17_29,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 3, offsetof(struct NR_On_Demand_DL_PRS_PerFreqLayer_r17, dl_prs_NumSymbolsReq_r17),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_dl_prs_NumSymbolsReq_r17_37,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 2, offsetof(struct NR_On_Demand_DL_PRS_PerFreqLayer_r17, dl_prs_CombSizeN_Req_r17),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_dl_prs_CombSizeN_Req_r17_43,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
