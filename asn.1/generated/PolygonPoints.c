...
asn_TYPE_member_t asn_MBR_PolygonPoints_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PolygonPoints, latitudeSign),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PolygonPoints, degreesLatitude),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PolygonPoints, degreesLongitude),
...
static const ber_tlv_tag_t asn_DEF_PolygonPoints_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_PolygonPoints_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_PolygonPoints_specs_1 = {
	sizeof(struct PolygonPoints),
	offsetof(struct PolygonPoints, _asn_ctx),
	asn_MAP_PolygonPoints_tag2el_1,
	3,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_PolygonPoints = {
	"PolygonPoints",
	"PolygonPoints",
	&asn_OP_SEQUENCE,
	asn_DEF_PolygonPoints_tags_1,
	sizeof(asn_DEF_PolygonPoints_tags_1)
		/sizeof(asn_DEF_PolygonPoints_tags_1[0]), /* 1 */
	asn_DEF_PolygonPoints_tags_1,	/* Same as above */
	sizeof(asn_DEF_PolygonPoints_tags_1)
		/sizeof(asn_DEF_PolygonPoints_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_PolygonPoints_1,
	3,	/* Elements count */
	&asn_SPC_PolygonPoints_specs_1	/* Additional specs */
};
