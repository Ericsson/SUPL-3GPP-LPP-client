...
static int
memb_shortKey_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_longKey_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	const BIT_STRING_t *st = (const BIT_STRING_t *)sptr;
	size_t size;
...
static asn_per_constraints_t asn_PER_memb_shortKey_constr_2 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  128,  128 }	/* (SIZE(128..128)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_longKey_constr_3 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  256,  256 }	/* (SIZE(256..256)) */,
	0, 0	/* No PER value map */
};
asn_per_constraints_t asn_PER_type_SETAuthKey_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  1,  1,  0,  1 }	/* (0..1,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_SETAuthKey_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SETAuthKey, choice.shortKey),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_shortKey_constr_2,  memb_shortKey_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SETAuthKey, choice.longKey),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_longKey_constr_3,  memb_longKey_constraint_1 },
		0, 0, /* No default value */
		"longKey"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_SETAuthKey = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_SETAuthKey_constr_1, CHOICE_constraint },
