...
int
Ver_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
asn_per_constraints_t asn_PER_type_Ver_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  64,  64 }	/* (SIZE(64..64)) */,
	0, 0	/* No PER value map */
};
static const ber_tlv_tag_t asn_DEF_Ver_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_Ver = {
	...
	sizeof(asn_DEF_Ver_tags_1)
		/sizeof(asn_DEF_Ver_tags_1[0]), /* 1 */
	{ 0, &asn_PER_type_Ver_constr_1, Ver_constraint },
	0, 0,	/* No members */
