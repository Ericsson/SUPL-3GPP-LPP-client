...
static asn_TYPE_member_t asn_MBR_ext1_5[] = {
	{ ATF_POINTER, 1, offsetof(struct BT_ProvideLocationInformation_r13__ext1, bt_AoA_Config_r18),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BT_AoA_Config_r18,
		0,
		{
...
static const asn_TYPE_tag2member_t asn_MAP_ext1_tag2el_5[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* bt-AoA-Config-r18 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_5 = {
	sizeof(struct BT_ProvideLocationInformation_r13__ext1),
	offsetof(struct BT_ProvideLocationInformation_r13__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_BT_ProvideLocationInformation_r13_1[] = {
	{ ATF_POINTER, 3, offsetof(struct BT_ProvideLocationInformation_r13, bt_MeasurementInformation_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct BT_ProvideLocationInformation_r13, bt_Error_r13),
	...
	{ ATF_POINTER, 1, offsetof(struct BT_ProvideLocationInformation_r13, ext1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext1_5,
		0,
...
static const int asn_MAP_BT_ProvideLocationInformation_r13_oms_1[] = { 0, 1, 2 };
