...
struct BT_Error_r13;
struct BT_AoA_Config_r18;

/* BT-ProvideLocationInformation-r13 */
typedef struct BT_ProvideLocationInformation_r13 {
	struct BT_MeasurementInformation_r13	*bt_MeasurementInformation_r13;	/* OPTIONAL */
	struct BT_Error_r13	*bt_Error_r13;	/* OPTIONAL */
	/*
	 * This type is extensible,
	 * possible extensions are below.
	 */
	struct BT_ProvideLocationInformation_r13__ext1 {
		struct BT_AoA_Config_r18	*bt_AoA_Config_r18;	/* OPTIONAL */
...
extern asn_SEQUENCE_specifics_t asn_SPC_BT_ProvideLocationInformation_r13_specs_1;
extern asn_TYPE_member_t asn_MBR_BT_ProvideLocationInformation_r13_1[3];
