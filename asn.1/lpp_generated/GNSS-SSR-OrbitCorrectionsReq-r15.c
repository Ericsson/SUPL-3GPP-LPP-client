...
static int
memb_orbit_IntegrityReq_r17_constraint_4(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_orbit_IntegrityReq_r17_constr_5 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_ext1_4[] = {
	{ ATF_POINTER, 1, offsetof(struct GNSS_SSR_OrbitCorrectionsReq_r15__ext1, orbit_IntegrityReq_r17),
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_orbit_IntegrityReq_r17_constr_5,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
			memb_orbit_IntegrityReq_r17_constraint_4
		},
...
static const asn_TYPE_tag2member_t asn_MAP_ext1_tag2el_4[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* orbit-IntegrityReq-r17 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_4 = {
	sizeof(struct GNSS_SSR_OrbitCorrectionsReq_r15__ext1),
	offsetof(struct GNSS_SSR_OrbitCorrectionsReq_r15__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_GNSS_SSR_OrbitCorrectionsReq_r15_1[] = {
	{ ATF_POINTER, 2, offsetof(struct GNSS_SSR_OrbitCorrectionsReq_r15, storedNavList_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct GNSS_SSR_OrbitCorrectionsReq_r15, ext1),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_ext1_4,
		0,
...
static const int asn_MAP_GNSS_SSR_OrbitCorrectionsReq_r15_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_GNSS_SSR_OrbitCorrectionsReq_r15_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_GNSS_SSR_OrbitCorrectionsReq_r15_tag2el_1[] = {
