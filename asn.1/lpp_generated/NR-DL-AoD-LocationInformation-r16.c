...
static asn_TYPE_member_t asn_MBR_ext1_7[] = {
	{ ATF_POINTER, 2, offsetof(struct NR_DL_AoD_LocationInformation_r16__ext1, locationCoordinates_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 1, offsetof(struct NR_DL_AoD_LocationInformation_r16__ext1, locationSource_r17),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_7 = {
	sizeof(struct NR_DL_AoD_LocationInformation_r16__ext1),
	offsetof(struct NR_DL_AoD_LocationInformation_r16__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_NR_DL_AoD_LocationInformation_r16_1[] = {
	{ ATF_POINTER, 2, offsetof(struct NR_DL_AoD_LocationInformation_r16, measurementReferenceTime_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct NR_DL_AoD_LocationInformation_r16, ext1),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_ext1_7,
		0,
...
static const int asn_MAP_NR_DL_AoD_LocationInformation_r16_oms_1[] = { 0, 1 };
