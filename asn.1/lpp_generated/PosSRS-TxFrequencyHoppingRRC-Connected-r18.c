...
asn_TYPE_member_t asn_MBR_PosSRS_TxFrequencyHoppingRRC_Connected_r18_1[] = {
	...
	{ ATF_POINTER, 7, offsetof(struct PosSRS_TxFrequencyHoppingRRC_Connected_r18, rf_TxRetunTimeFR1_r18),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 6, offsetof(struct PosSRS_TxFrequencyHoppingRRC_Connected_r18, rf_TxRetunTimeFR2_r18),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
