...
struct QzsEphemeris {
    ...
    NODISCARD bool match(QzsEphemeris const& other) const NOEXCEPT {
    ...
    NODISCARD bool compare(QzsEphemeris const& other) const NOEXCEPT {
...
template <>
struct TypeName<ephemeris::QzsEphemeris> {
    static char const* name() { return "ephemeris::QzsEphemeris"; }
};
}  // namespace streamline
