...
UbxRxmSpartn::UbxRxmSpartn(raw::RxmSpartn payload, std::vector<uint8_t> data) NOEXCEPT
...
std::unique_ptr<Message> UbxRxmSpartn::clone() const NOEXCEPT {
    return std::unique_ptr<Message>{new UbxRxmSpartn{*this}};
}
