...
bool Satellite::compute_position_and_velocity(EphemerisEngine const& ephemeris) NOEXCEPT {
    ...
    EphemerisEngine::Satellite result{};
    if (!ephemeris.evaluate(id, t, relativistic_model, result)) {
        return false;
    }
