...
asn_TYPE_member_t asn_MBR_A_GNSS_Error_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct A_GNSS_Error, choice.locationServerErrorCauses),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct A_GNSS_Error, choice.targetDeviceErrorCauses),
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_A_GNSS_Error_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		CHOICE_constraint
	},
