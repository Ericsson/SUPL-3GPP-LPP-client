...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_idleStateForMeasurements_r14_constr_9,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_periodicAssistanceData_r15_constr_12,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
			memb_periodicAssistanceData_r15_constraint_11
		},
		0, 0, /* No default value */
...
static asn_TYPE_member_t asn_MBR_ext3_15[] = {
	{ ATF_POINTER, 1, offsetof(struct A_GNSS_ProvideCapabilities__ext3, scheduledLocationRequestSupported_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext3_specs_15 = {
	sizeof(struct A_GNSS_ProvideCapabilities__ext3),
	offsetof(struct A_GNSS_ProvideCapabilities__ext3, _asn_ctx),
