...
typedef struct DL_PRS_Resource_ARP_Element_r16 {
	 ...
	 */
	struct DL_PRS_Resource_ARP_Element_r16__ext1 {
		struct RelativeCartesianLocation_r18	*dl_PRS_Resource_ARP_locationCartesian_r18;	/* OPTIONAL */
		struct NR_IntegrityLocationBounds_r18	*nr_IntegrityDL_PRS_ResourceARP_LocationBounds_r18;	/* OPTIONAL */
...
extern asn_TYPE_member_t asn_MBR_DL_PRS_Resource_ARP_Element_r16_1[2];
