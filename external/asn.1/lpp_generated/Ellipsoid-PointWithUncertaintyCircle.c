...
static int
memb_uncertainty_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
asn_TYPE_member_t asn_MBR_Ellipsoid_PointWithUncertaintyCircle_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Ellipsoid_PointWithUncertaintyCircle, latitudeSign),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Ellipsoid_PointWithUncertaintyCircle, degreesLatitude),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Ellipsoid_PointWithUncertaintyCircle, degreesLongitude),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Ellipsoid_PointWithUncertaintyCircle, uncertainty),
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_uncertainty_constr_7,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
			memb_uncertainty_constraint_1
		},
		0, 0, /* No default value */
		"uncertainty"
		},
};
static const ber_tlv_tag_t asn_DEF_Ellipsoid_PointWithUncertaintyCircle_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_Ellipsoid_PointWithUncertaintyCircle_tag2el_1[] = {
