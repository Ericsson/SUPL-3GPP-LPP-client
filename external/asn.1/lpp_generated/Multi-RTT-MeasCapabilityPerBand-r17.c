...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_nr_NTN_MeasAndReport_r18_constr_13 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_nr_NTN_MeasAndReport_r18_value2enum_13[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_nr_NTN_MeasAndReport_r18_enum2value_13[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_nr_NTN_MeasAndReport_r18_specs_13 = {
	asn_MAP_nr_NTN_MeasAndReport_r18_value2enum_13,	/* "tag" => N; sorted by tag */
	asn_MAP_nr_NTN_MeasAndReport_r18_enum2value_13,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_nr_NTN_MeasAndReport_r18_tags_13[] = {
	(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_nr_NTN_MeasAndReport_r18_13 = {
	"nr-NTN-MeasAndReport-r18",
	"nr-NTN-MeasAndReport-r18",
	&asn_OP_NativeEnumerated,
	asn_DEF_nr_NTN_MeasAndReport_r18_tags_13,
	sizeof(asn_DEF_nr_NTN_MeasAndReport_r18_tags_13)
		/sizeof(asn_DEF_nr_NTN_MeasAndReport_r18_tags_13[0]) - 1, /* 1 */
	asn_DEF_nr_NTN_MeasAndReport_r18_tags_13,	/* Same as above */
	sizeof(asn_DEF_nr_NTN_MeasAndReport_r18_tags_13)
		/sizeof(asn_DEF_nr_NTN_MeasAndReport_r18_tags_13[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_nr_NTN_MeasAndReport_r18_constr_13,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		NativeEnumerated_constraint
	},
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_Multi_RTT_MeasCapabilityPerBand_r17_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct Multi_RTT_MeasCapabilityPerBand_r17, supportOfDL_PRS_FirstPathRSRP_r17),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct Multi_RTT_MeasCapabilityPerBand_r17, dl_PRS_MeasRRC_Inactive_r17),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct Multi_RTT_MeasCapabilityPerBand_r17, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext1_8,
		0,
...
static const int asn_MAP_Multi_RTT_MeasCapabilityPerBand_r17_oms_1[] = { 1, 2, 3 };
