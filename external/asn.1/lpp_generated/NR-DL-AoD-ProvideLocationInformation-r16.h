...
typedef struct NR_DL_AoD_ProvideLocationInformation_r16 {
	 ...
	 */
	struct NR_DL_AoD_ProvideLocationInformation_r16__ext1 {
		struct NR_DL_AoD_ProvideLocationInformation_r16__ext1__nr_DL_AoD_SignalMeasurementInstances_r17 {
			A_SEQUENCE_OF(struct NR_DL_AoD_SignalMeasurementInformation_r16) list;
			
			/* Context for parsing across buffer boundaries */
			asn_struct_ctx_t _asn_ctx;
		} *nr_DL_AoD_SignalMeasurementInstances_r17;
		struct NR_DL_AoD_ProvideLocationInformation_r16__ext1__nr_DL_AoD_LocationInformationInstances_r17 {
			A_SEQUENCE_OF(struct NR_DL_AoD_LocationInformation_r16) list;
...
extern asn_TYPE_member_t asn_MBR_NR_DL_AoD_ProvideLocationInformation_r16_1[4];
