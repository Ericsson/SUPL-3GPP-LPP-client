...
typedef struct TRP_LocationInfoElement_r16 {
	 ...
	 */
	struct TRP_LocationInfoElement_r16__ext1 {
		struct RelativeCartesianLocation_r18	*trp_LocationCartesian_r18;	/* OPTIONAL */
		struct NR_IntegrityLocationBounds_r18	*nr_IntegrityTRP_LocationBounds_r18;	/* OPTIONAL */
...
extern asn_TYPE_member_t asn_MBR_TRP_LocationInfoElement_r16_1[8];
