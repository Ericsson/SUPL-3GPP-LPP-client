...
static TsInt leap_seconds_utc_gps() {
    ...
    // instead.
    constexpr TsInt leap_seconds = 18;
    return leap_seconds;
}
...
GPS_Time::GPS_Time(TsInt day, TsFloat tod) : tm{} {
    tm.add(DAY_IN_SECONDS * day);
    tm.add(tod);
}

GPS_Time::GPS_Time(TsInt week, TsInt tow, TsFloat fractions) : tm{} {
