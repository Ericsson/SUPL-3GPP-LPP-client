...
static asn_TYPE_member_t asn_MBR_c1_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Abort__criticalExtensions__c1, choice.abort_r9),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_Abort_r9_IEs,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"abort-r9"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct Abort__criticalExtensions__c1, choice.spare3),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Abort__criticalExtensions__c1, choice.spare2),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Abort__criticalExtensions__c1, choice.spare1),
...
static const asn_TYPE_tag2member_t asn_MAP_c1_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* abort-r9 */
...
static asn_CHOICE_specifics_t asn_SPC_c1_specs_3 = {
	...
	offsetof(struct Abort__criticalExtensions__c1, _asn_ctx),
	offsetof(struct Abort__criticalExtensions__c1, present),
	sizeof(((struct Abort__criticalExtensions__c1 *)0)->present),
	asn_MAP_c1_tag2el_3,
...
static asn_SEQUENCE_specifics_t asn_SPC_criticalExtensionsFuture_specs_8 = {
	sizeof(struct Abort__criticalExtensions__criticalExtensionsFuture),
	offsetof(struct Abort__criticalExtensions__criticalExtensionsFuture, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_criticalExtensions_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Abort__criticalExtensions, choice.c1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Abort__criticalExtensions, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static asn_CHOICE_specifics_t asn_SPC_criticalExtensions_specs_2 = {
	sizeof(struct Abort__criticalExtensions),
	offsetof(struct Abort__criticalExtensions, _asn_ctx),
	offsetof(struct Abort__criticalExtensions, present),
	sizeof(((struct Abort__criticalExtensions *)0)->present),
...
asn_TYPE_member_t asn_MBR_Abort_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Abort, criticalExtensions),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
