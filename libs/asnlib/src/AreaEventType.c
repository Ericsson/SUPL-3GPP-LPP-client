 ...
 */
asn_per_constraints_t asn_PER_type_AreaEventType_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  2,  2,  0,  3 }	/* (0..3,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_AreaEventType_value2enum_1[] = {
	{ 0,	12,	"enteringArea" },
	{ 1,	10,	"insideArea" },
	{ 2,	11,	"outsideArea" },
	{ 3,	11,	"leavingArea" }
...
static const unsigned int asn_MAP_AreaEventType_enum2value_1[] = {
	0,	/* enteringArea(0) */
	1,	/* insideArea(1) */
	3,	/* leavingArea(3) */
	2	/* outsideArea(2) */
...
const asn_INTEGER_specifics_t asn_SPC_AreaEventType_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_AreaEventType_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_AreaEventType = {
	...
	sizeof(asn_DEF_AreaEventType_tags_1)
		/sizeof(asn_DEF_AreaEventType_tags_1[0]), /* 1 */
	{ 0, &asn_PER_type_AreaEventType_constr_1, NativeEnumerated_constraint },
