...
asn_TYPE_descriptor_t asn_DEF_dl_PRS_Resource_ARP_List_r16_3 = {
	...
	{ 0, &asn_PER_type_dl_PRS_Resource_ARP_List_r16_constr_3, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_DL_PRS_ResourceSets_TRP_Element_r16_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct DL_PRS_ResourceSets_TRP_Element_r16, dl_PRS_Resource_ARP_List_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_dl_PRS_Resource_ARP_List_r16_3,
		0,
		{ 0, &asn_PER_memb_dl_PRS_Resource_ARP_List_r16_constr_3,  memb_dl_PRS_Resource_ARP_List_r16_constraint_1 },
		0, 0, /* No default value */
		"dl-PRS-Resource-ARP-List-r16"
		},
};
static const int asn_MAP_DL_PRS_ResourceSets_TRP_Element_r16_oms_1[] = { 0, 1 };
