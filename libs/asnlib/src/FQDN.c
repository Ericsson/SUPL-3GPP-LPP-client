...
int
FQDN_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
asn_per_constraints_t asn_PER_type_FQDN_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_FQDN = {
	...
	sizeof(asn_DEF_FQDN_tags_1)
		/sizeof(asn_DEF_FQDN_tags_1[0]), /* 1 */
	{ 0, &asn_PER_type_FQDN_constr_1, FQDN_constraint },
	0, 0,	/* No members */
	0	/* No specifics */
};
