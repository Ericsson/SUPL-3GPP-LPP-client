...
asn_TYPE_member_t asn_MBR_GNSS_RTK_ResidualsReq_r15_1[] = {
	{ ATF_POINTER, 2, offsetof(struct GNSS_RTK_ResidualsReq_r15, stationID_r15),
	...
	{ ATF_POINTER, 1, offsetof(struct GNSS_RTK_ResidualsReq_r15, linkCombinations_PrefList_r15),
...
static const asn_TYPE_tag2member_t asn_MAP_GNSS_RTK_ResidualsReq_r15_tag2el_1[] = {
