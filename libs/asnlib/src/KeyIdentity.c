...
int
KeyIdentity_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
asn_per_constraints_t asn_PER_type_KeyIdentity_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  128,  128 }	/* (SIZE(128..128)) */,
	0, 0	/* No PER value map */
};
static const ber_tlv_tag_t asn_DEF_KeyIdentity_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_KeyIdentity = {
	...
	sizeof(asn_DEF_KeyIdentity_tags_1)
		/sizeof(asn_DEF_KeyIdentity_tags_1[0]), /* 1 */
	{ 0, &asn_PER_type_KeyIdentity_constr_1, KeyIdentity_constraint },
	0, 0,	/* No members */
