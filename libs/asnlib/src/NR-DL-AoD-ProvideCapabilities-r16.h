...
/* Dependencies */
typedef enum NR_DL_AoD_ProvideCapabilities_r16__periodicalReporting_r16 {
	NR_DL_AoD_ProvideCapabilities_r16__periodicalReporting_r16_supported	= 0
} e_NR_DL_AoD_ProvideCapabilities_r16__periodicalReporting_r16;
...
typedef struct NR_DL_AoD_ProvideCapabilities_r16 {
	...
	struct NR_DL_PRS_MeasCapability_r16	*nr_DL_PRS_MeasCapability_r16	/* OPTIONAL */;
	/*
...
/* Implementation */
/* extern asn_TYPE_descriptor_t asn_DEF_periodicalReporting_r16_3;	// (Use -fall-defs-global to expose) */
...
extern asn_TYPE_member_t asn_MBR_NR_DL_AoD_ProvideCapabilities_r16_1[3];
