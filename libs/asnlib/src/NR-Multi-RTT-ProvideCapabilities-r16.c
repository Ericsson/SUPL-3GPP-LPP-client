 ...
 */
static int
memb_nr_Multi_RTT_MeasSupported_r16_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_nr_Multi_RTT_MeasSupported_r16_constr_4 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
...
asn_TYPE_member_t asn_MBR_NR_Multi_RTT_ProvideCapabilities_r16_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NR_Multi_RTT_ProvideCapabilities_r16, nr_UL_SRS_MeasCapability_r16),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NR_Multi_RTT_ProvideCapabilities_r16, nr_Multi_RTT_MeasSupported_r16),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_nr_Multi_RTT_MeasSupported_r16_constr_4,  memb_nr_Multi_RTT_MeasSupported_r16_constraint_1 },
		0, 0, /* No default value */
		"nr-Multi-RTT-MeasSupported-r16"
		},
	{ ATF_POINTER, 2, offsetof(struct NR_Multi_RTT_ProvideCapabilities_r16, additionalPathsReport_r16),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct NR_Multi_RTT_ProvideCapabilities_r16, periodicalReporting_r16),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_NR_Multi_RTT_ProvideCapabilities_r16_oms_1[] = { 3, 4 };
...
static const asn_TYPE_tag2member_t asn_MAP_NR_Multi_RTT_ProvideCapabilities_r16_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* nr-DL-PRS-MeasCapability-r16 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* nr-UL-SRS-MeasCapability-r16 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* nr-Multi-RTT-MeasSupported-r16 */
