...
asn_TYPE_member_t asn_MBR_NavIC_CDC_r16_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NavIC_CDC_r16, navic_ClockBiasCorrection_r16),
		...
		0,
		{ 0, &asn_PER_memb_navic_ClockBiasCorrection_r16_constr_2,  memb_navic_ClockBiasCorrection_r16_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NavIC_CDC_r16, navic_ClockDriftCorrection_r16),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_navic_ClockDriftCorrection_r16_constr_3,  memb_navic_ClockDriftCorrection_r16_constraint_1 },
		0, 0, /* No default value */
