...
static GNSS_SupportList* build_support_list() {
...

    {
        ...
        auto posModes = BitString::allocate(8, &element->agnss_Modes.posModes);
        posModes->set_bit(PositioningModes__posModes_ue_based);
        posModes->set_bit(PositioningModes__posModes_ue_assisted);
        ...
        auto posModes2 =
            BitString::allocate(8, &ext->ha_gnss_Modes_r15->posModes);
        posModes2->set_bit(PositioningModes__posModes_ue_based);

        auto signals =
            BitString::allocate(8, &element->gnss_Signals.gnss_SignalIDs);
        signals->set_bit(0);
        signals->set_bit(1);
        signals->set_bit(2);
        signals->set_bit(3);
...
static AssistanceDataSupportList* build_assistance_support() {
    ...
    auto as_ext1 = ALLOC_ZERO(GNSS_CommonAssistanceDataSupport::
                                  GNSS_CommonAssistanceDataSupport__ext1);

    auto rtk_reference_station_support =
        ALLOC_ZERO(GNSS_RTK_ReferenceStationInfoSupport_r15);
    auto rtk_auxiliary_station_support =
        ALLOC_ZERO(GNSS_RTK_AuxiliaryStationDataSupport_r15);
    as_ext1->gnss_RTK_ReferenceStationInfoSupport_r15 =
        rtk_reference_station_support;
    as_ext1->gnss_RTK_AuxiliaryStationDataSupport_r15 =
        rtk_auxiliary_station_support;
...

    {
        ...
        auto ext             = ALLOC_ZERO(GNSS_GenericAssistDataSupportElement::
                                  GNSS_GenericAssistDataSupportElement__ext2);
        gps_assistance->ext2 = ext;
        ext->gnss_RTK_ObservationsSupport_r15 =
            ALLOC_ZERO(GNSS_RTK_ObservationsSupport_r15_t);
        auto signals =
            BitString::allocate(8, &ext->gnss_RTK_ObservationsSupport_r15
                                        ->gnssSignalIDs_r15.gnss_SignalIDs);
        signals->set_bit(0);
        signals->set_bit(1);
        signals->set_bit(2);
        signals->set_bit(3);
        ...
        ext->gnss_RTK_ResidualsSupport_r15 =
            ALLOC_ZERO(GNSS_RTK_ResidualsSupport_r15_t);
        ...
        {
            GNSS_Link_Combinations_r15_t* link =
                ALLOC_ZERO(GNSS_Link_Combinations_r15_t);
    ...
    {
        auto glonass_assistance =
            ALLOC_ZERO(GNSS_GenericAssistDataSupportElement_t);
        ...
        ext->glo_RTK_BiasInformationSupport_r15 =
            ALLOC_ZERO(GLO_RTK_BiasInformationSupport_r15_t);
        ext->gnss_RTK_ResidualsSupport_r15 =
            ALLOC_ZERO(GNSS_RTK_ResidualsSupport_r15_t);
        auto link_list =
            &ext->gnss_RTK_ResidualsSupport_r15->link_combinations_support_r15;
    ...
    {
        auto galileo_assistance =
            ALLOC_ZERO(GNSS_GenericAssistDataSupportElement);
...
LPP_Message* lpp_provide_capabilities(LPP_Transaction* transaction, bool segmentation) {
    auto message =
        lpp_create(transaction, LPP_MessageBody__c1_PR_provideCapabilities);
    ...
    auto ext2 = ALLOC_ZERO(
        A_GNSS_ProvideCapabilities::A_GNSS_ProvideCapabilities__ext2);

    auto pad                         = BitString::allocate(8);
    ext2->periodicAssistanceData_r15 = pad;
    pad->set_bit(
        A_GNSS_ProvideCapabilities__ext2__periodicAssistanceData_r15_solicited);
    pad->set_bit(
        A_GNSS_ProvideCapabilities__ext2__periodicAssistanceData_r15_unsolicited);
    ...
    auto ecid_MeasSupported =
        BitString::allocate(8, &ecid_capabilities->ecid_MeasSupported);
    ecid_MeasSupported->set_bit(
        ECID_ProvideCapabilities__ecid_MeasSupported_rsrpSup);
    ecid_MeasSupported->set_bit(
        ECID_ProvideCapabilities__ecid_MeasSupported_rsrqSup);
