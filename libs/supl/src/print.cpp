...
void Printer::value(const ::Notification& x) {
    appendf("{ /* unsupported */ }");
}

void Printer::value(const ::QoP& x) {
    appendf("{ /* unsupported */ }");
}
...
void Printer::value(const ::BIT_STRING_s& x) {
    appendf("{ /* unsupported */ }");
}

void Printer::value(const ::Ver2_SUPL_INIT_extension& x) {
    appendf("{ /* unsupported */ }");
}
...
void Printer::value(const ::Ver2_PosTechnology_extension& x) {
    appendf("{ /* unsupported */ }");
}
...
void Printer::value(const ::Ver2_PosProtocol_extension& x) {
    push('{');
...
void Printer::value(const ::NMR& x) {
    appendf("{ /* unsupported */ }");
}

void Printer::value(const ::WcdmaCellInformation& x) {
    appendf("{ /* unsupported */ }");
}

void Printer::value(const ::CdmaCellInformation& x) {
    appendf("{ /* unsupported */ }");
}
...
void Printer::value(const ::MeasResultListEUTRA& x) {
    appendf("{ /* unsupported */ }");
}

void Printer::value(const ::Ver2_SETCapabilities_extension& x) {
    appendf("{ /* unsupported */ }");
}

void Printer::value(const ::Ver2_SUPL_START_extension& x) {
    appendf("{ /* unsupported */ }");
}
