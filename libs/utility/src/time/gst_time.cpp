...
static s64 leap_seconds_utc_gst() {
...
GST_Time::GST_Time(s64 day, f64 tod) : tm{} {
    tm.add(DAY_IN_SECONDS * day);
    tm.add(tod);
}

GST_Time::GST_Time(s64 week, s64 tow, f64 fractions) : tm{} {
